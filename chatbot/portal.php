<style>
	#chat_convo{
		max-height: 65vh;
		/* en caso de querer imagen dentro de la bandeja de mensaje poner la ruta aqui
		background-image: url('dist/img/avatar.png');
...
<div background-image: url('dist/img/avatar.png');
