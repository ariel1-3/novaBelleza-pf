...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
	   ...
	   <ol class="breadcrumb">
		 ...
		 <div class="col-md-7">
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Editar Galeria</h3>
			<form class="form-horizontal" id="editar_banner">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-9">
				  <input type="number" min="0" class="form-control" id="orden" name="orden" value="<?php echo $orden;?>">
				</div>
			  </div>
	...
	<script src="js/jasny-bootstrap.min.js"></script>
		...
		<?php include("../../hospital-master/hospital-master/footer.php");?>
  <script>
